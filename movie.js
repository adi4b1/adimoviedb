...
let videoEmbed = video
  ...
  : "<p>No trailer available.</p>";
      ...
      sd.innerHTML+=`
           ...
           <a href="https://adi4b1.github.io/projects/adi_movie_db/about.html?id=${j.id}" style="text-decoration:none;">
                <div>
      ...
      credit.cast.forEach((actor)=>{
        ...
        modalactors.innerHTML+= `           
            ...
            <a href="https://adi4b1.github.io/projects/adi_movie_db/person.html?id=${actor.id}?name=${actor.name}">
  ...
  forLabelMain.innerHTML=''
    ...
    //    getMovieVideos(cvData,i.id)
        ...
        res.innerHTML += `
            ...
            <div id="cardBody" class="card">
           <a href="https://adi4b1.github.io/projects/adi_movie_db/about.html?id=${i.id}" style="text-decoration:none;">
                <div>
