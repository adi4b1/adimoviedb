...
async function getMovieData() {
  ...
  try {
    ...
    credit1.cast.forEach((i) => {
      ...
      castCon.innerHTML += `
         <a href="https://adimoviedb-calagubtb-kesavs-projects-429bf22a.vercel.app/projects/adi_movie_db/person.html?id=${i.id}?name=${upgrade_name}" style="text-decoration:none;">
